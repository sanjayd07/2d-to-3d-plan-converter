...
class ConversionWorker(QThread):
    ...
    def run(self):
        try:
            ...
            target_file = target_dir / "floorplan.blend"
    ...
    def create_blend_file(self, blender_path, data_path, target_file):
        ...
        try:
            ...
            subprocess.run([
                ...
                str(target_file)  # Output path
            ], check=True, capture_output=True)
            
        except subprocess.CalledProcessError as e:
            raise Exception(f"Blender execution failed: {e.stderr.decode()}")
        except Exception as e:
            raise Exception(f"Failed to create .blend file: {str(e)}")
...
class MainWindow(QMainWindow):
    ...
    def open_in_blender(self):
        ...
        blend_file = Path("Target/floorplan.blend")
